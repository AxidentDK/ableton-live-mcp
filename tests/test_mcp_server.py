...
def test_tool_list_stays_compact():
    ...
    # note to the two capture-tool descriptions, then again when play_from/play_loop
    # (extra transport schema) + live_record_track_to_wav (a full-schema turnkey
    # tool) landed; keep new tools terse so this stays meaningful.
